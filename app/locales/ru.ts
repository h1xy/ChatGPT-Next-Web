...
const ru: PartialLocaleType = {
  ...
  Error: {
    Unauthorized:
      "❗Пароль находится в закрепленном сообщении канала Telegram **[ChatGPT/AI News](https://t.me/AI_News_CN)**\n🔓Перейдите на страницу **[входа](/#/auth)** и введите пароль",
  },
  ChatItem: {
  ...
  Store: {
    ...
    BotHello: "❗Пароль находится в закрепленном сообщении канала Telegram **[ChatGPT/AI News](https://t.me/AI_News_CN)**",
