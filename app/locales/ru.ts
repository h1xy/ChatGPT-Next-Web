...
const ru: PartialLocaleType = {
  ...
  Error: {
    Unauthorized:
      "❗Пожалуйста, подпишитесь на канал Telegram **[ChatGPT/AI News](https://t.me/AI_News_CN)**, чтобы получить последний закрепленный пароль\n🔓Перейдите на страницу **[входа](/#/auth)** и введите пароль\n💡Нажмите, чтобы увидеть часто задаваемые вопросы и инструкции по использованию: **[кликните здесь](https://flowus.cn/share/11ac02de-b6e4-4328-abcf-11160870d7b7)**\n⭐ Если вы хотите стабильно использовать GPT-4 и другие более продвинутые модели, пожалуйста, поддержите **[платную версию](https://api.g4f.icu)**",
  },
  ChatItem: {
  ...
  Store: {
    ...
    BotHello: "❗Пожалуйста, подпишитесь на канал Telegram **[ChatGPT/AI News](https://t.me/AI_News_CN)**, чтобы получить последний закрепленный пароль\n💡Нажмите, чтобы увидеть часто задаваемые вопросы и инструкции по использованию: **[кликните здесь](https://flowus.cn/share/11ac02de-b6e4-4328-abcf-11160870d7b7)**\n⭐ Если вы хотите стабильно использовать GPT-4 и другие более продвинутые модели, пожалуйста, поддержите **[платную версию](https://api.g4f.icu)**",
